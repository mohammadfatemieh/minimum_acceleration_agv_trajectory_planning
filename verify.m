function result = verify(fourier_order, coef_list, keyframe_list, dangerous_region)
  ...
  pos_x_f = fourier(fourier_order, [keyframe_list(1, time_idx), keyframe_list(2, time_idx)]);
  pos_x_f = pos_x_f.scale(coef_list(1 : fourier_size, 1)');
  pos_y_f = fourier(fourier_order, [keyframe_list(1, time_idx), keyframe_list(2, time_idx)]);
  pos_y_f = pos_y_f.scale(coef_list((keyframe_cnt - 1) * fourier_size + 1 : keyframe_cnt * fourier_size, 1)');
